 ...
 * @since 2.0
 */
public class FetchCounterOperation extends FutureOperation<Long>
{
	...
	protected Long convert(RiakMessage rawResponse) throws ExecutionException
	{
		...
		RiakKvPB.RpbCounterGetResp response = null;
		try
		{
			response = RiakKvPB.RpbCounterGetResp.parseFrom(rawResponse.getData());
		}
